    ...
    async def execute(self, task: str, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "result": str(e),
                "status": "error",
                "failure_explanation": AgentFailureExplanation(status="error", reason=str(e), missing_evidence=["知识库证据"]).model_dump(),
                "model": self._extract_model_name(),
                "inputTokens": 0,
                "outputTokens": 0,
                "costEstimate": 0,
