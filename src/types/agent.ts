...
export const DIAGNOSIS_MODES: DiagnosisModeInfo[] = [
  ...
  { id: 'direct', name: 'Direct', description: '单 Agent 直出，最快速响应', strategy: 'manual' },
  { id: 'plan_execute', name: 'Plan & Execute', description: '先规划再执行，平衡效率与质量', strategy: 'manual' },
  { id: 'react', name: 'ReAct', description: '推理-行动-观察迭代，适合复杂排障', strategy: 'manual' },
  { id: 'hierarchical', name: 'Hierarchical', description: 'Orchestrator 调度 specialist 并聚合', strategy: 'manual' },
];

export const LEGACY_MODE_COMPAT_MAP: Record<string, Exclude<DiagnosisMode, 'auto' | 'prd_minimal' | 'prd_standard' | 'prd_deep' | 'prd_swarm'>> = {
  prd_minimal: 'direct',
